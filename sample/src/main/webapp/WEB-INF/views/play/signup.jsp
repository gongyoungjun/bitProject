...
<!-- Bootstrap Core CSS -->
<link href="${pageContext.request.contextPath}/resources/boardFront/css/bootstrap.min.css"
	rel="stylesheet">

<!-- Custom CSS -->
<!-- <link href="css/login.css" rel="stylesheet"> -->
<link href="${pageContext.request.contextPath}/resources/boardFront/css/clean-blog.css"
	rel="stylesheet">
		...
		<div class="row">
			<div class="main" style="background-color: #141414">
				...
				<form name="replyFrm" action="/${pageContext.request.contextPath}/newMember" enctype="multi/formhipdata" method="post"> 
					...
					<input type="hidden" name="profile_img" id="profile_img" src="${pageContext.request.contextPath}/resources/img/play/basicProfile.jpg"/>
	
					</div>

					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12" id="sendButton">
							<a id="sendButton" href="#" class="btn btn-sm btn-info btn-block" style="background-color: #141414">회원가입</a><p><br>
